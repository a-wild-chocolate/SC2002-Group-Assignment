public class CommitteeMember extends Account {

	private Camp campManaged;
	private int point;

	public Camp getCampManaged() {
		return this.campManaged;
	}
	 ...
	 * @param campManaged
	 */
	public void setCampManaged(Camp campManaged) {
		this.campManaged = campManaged;
	}
